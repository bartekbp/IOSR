...
\begin{tikzpicture} 
    \begin{umlsystem}[x=0, y=0, fill=red!10]{KafLog} 
        ...
        \foreach \x/\a in {2/Zarejestruj agenta, 1/Pokaż stan systemu, 0/Pokaż statystyki agenta, -1/Pokaż statystyki zbiorcze, -2/Stwórz raport w HTML, -3/Pokaż historię logów} {
